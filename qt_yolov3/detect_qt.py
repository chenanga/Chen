        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if save_img:
                if dataset.mode == 'image':
                    print("save")
                    #print("save_path",'im0',save_path.split('\\')[-1],im0)
                    #cv2.imwrite('H:\\uyolov3\\uyolov3\\yolov3-master\\yolov3-master\\data\\chen_output_image\\'+save_path.split('\\')[-1], im0)
                    #4月25修改   下面是修改之前的
...
# if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    #default='runs/train/exp3/weights/best.pt'
    parser.add_argument('--weights', nargs='+', type=str, default='weights\\yolov3.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='./data/test_img', help='source')  # file/folder, 0 for webcam
